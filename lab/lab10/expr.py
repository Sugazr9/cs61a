...
class Expr:
    ...
    This type of tree is called an "abstract syntax tree".
...
class Name(Expr):
    ...
    def eval(self, env):
        ...
        if self.string in env:
            ...
            raise NameError(self.string + ' is not defined in current environment.')
...
class Value:
    ...
    functions with different parent environments.
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        for parameter in self.parameters:
            copy_env[parameter] = arguments[0]
