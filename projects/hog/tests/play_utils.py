...
class GameState(object):
    ...
    def successor(self, other):
        ...
        """
        return self.who != other.who and self.is_over() and (self.score0 != other.score0 or self.score1 != other.score1)
    ...
    for i in range(NUM_TESTS):
        ...
        if incorrect != -1:
            ...
            print('Implementation diverged from solution at turn',
                  '{0} (error_id: {1})'.format(incorrect, hash((trace[incorrect], incorrect, i))))
            break
